...
import { clearLoginInfo } from "../services/mmkv.service";
...
export default function RegisterScreen() {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      try {
        await signOut(auth);
        console.log(" Firebase signOut selesai");
      } catch (err) {
...
const styles = StyleSheet.create({
  ...
  loginText: { fontSize: 14, color: "#6a4a3c" },
  loginLink: { fontSize: 14, color: "#7b5a43", fontWeight: "600" },
